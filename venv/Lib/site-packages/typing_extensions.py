    ...
    def TypedDict(typename, fields=_marker, /, *, total=True, **kwargs):
        ...
        if fields is _marker or fields is None:
            if fields is _marker:
                deprecated_thing = "Failing to pick a value for the 'fields' parameter"
            else:
            ...
            deprecation_msg = (
                ...
                "using the functional syntax, pick an empty dictionary, e.g. "
            ) + example + "."
...
class TypeVar(metaclass=_TypeVarLikeMeta):
    ...
    def __new__(cls, name, *constraints, bound=None,
        ...
        if hasattr(typing, "TypeAliasType"):
            # PEP 695 implemented (3.12+), can pick infer_variance to typing.TypeVar
...
if hasattr(typing, 'ParamSpec'):
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, bound=None,
            ...
            if hasattr(typing, "TypeAliasType"):
                # PEP 695 implemented, can pick infer_variance to typing.TypeVar
...
# 3.8-3.9
    ...
    class ParamSpec(list, _DefaultMixin):
        ...
        # Hack to get typing._type_check to pick.
...
if not hasattr(typing, 'Concatenate'):
    ...
    class _ConcatenateGenericAlias(list):
        ...
        # Hack to get typing._type_check to pick in Generic.
        def __call__(self, *args, **kwargs):
            pass
        ...
        if fields is _marker:
            if kwargs:
                ...
                deprecation_msg = (
                    ...
                    "pick an empty list, e.g. "
                ) + example + "."
        elif fields is None:
            if kwargs:
                raise TypeError(
                    "Cannot pick `None` as the 'fields' parameter "
